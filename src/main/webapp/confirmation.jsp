...
<body>
	...
	<div class="confirmation">
		...
		<div class="confirmation__bottom">
			<span>Pedido número: <strong>1</strong></span>
			<section>
				<div class="confirmation__bottom__address">
					<h3>Endereço</h3>
					<strong class="confirmation__bottom__address__name">Eduardo
						Teste</strong>
					<p class="confirmation__bottom__address__street">Rua X</p>
					<p class="confirmation__bottom__address__neighborhood">Parque
						XPTO</p>
					<p class="confirmation__bottom__address__postalCode">05121-120</p>
					<p class="confirmation__bottom__address__tel">11 97238-4255</p>
				</div>
				<div class="confirmation__bottom__payment">
